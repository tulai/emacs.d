;;Set emacs to use xelatex for org-mode
;; org-mode
...
(setq org-export-latex-listings-options
      '(
        ...
        ("stepnumber" "1")                                          ; 行号递增
        ("backgroundcolor" "\\color{white}")                         ; 代码框背景色
        ("tabsize" "4")                                             ; TAB等效空格数
...
;; 导出Beamer的设置;; allow for export=>beamer by placing #+LaTeX_CLASS: beamer in org files;;-----------------------------------------------------------------------------
(add-to-list 'org-export-latex-classes
...
\\beamertemplateballitem\\setbeameroption{show notes}
\\usepackage{graphicx}
\\usepackage{tikz}
\\usepackage{xcolor}
\\usepackage{xeCJK}
